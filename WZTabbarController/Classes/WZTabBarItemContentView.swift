...
@objc public enum WZTabBarItemContentMode : Int {
...
@objcMembers open class WZTabBarItemContentView: UIView {
    ...
    open var itemContentMode: WZTabBarItemContentMode = .alwaysTemplate {
        didSet {
            self.updateDisplay()
        }
    }
    ...
    open var badgeColor: UIColor? {
        didSet {
            if let _ = badgeColor {
                ...
                self.badgeView.badgeColor = WZTabBarItemBadgeView.defaultBadgeColor
            }
        }
    }
    open var badgeView: WZTabBarItemBadgeView = WZTabBarItemBadgeView() {
        willSet {
    ...
    open func updateLayout() {
        ...
        if self.itemContentMode == .alwaysTemplate {
            ...
            if !imageView.isHidden && !titleLabel.isHidden {
                titleLabel.font = UIFont.boldSystemFont(ofSize: f)
