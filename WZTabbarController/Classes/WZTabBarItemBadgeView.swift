...
/*
 * WZTabBarItemBadgeView
 * 这个类定义了item中使用的badge视图样式，默认为WZTabBarItemBadgeView类对象。
 * 你可以设置WZTabBarItemContentView的badgeView属性为自定义的WZTabBarItemBadgeView子类，这样就可以轻松实现 自定义通知样式了。
 */
@objcMembers open class WZTabBarItemBadgeView: UIView {
