...
/*
 * WZTabBarItem继承自UITabBarItem，目的是为WZTabBarItemContentView提供UITabBarItem属性的设置。
 ...
 */
@available(iOS 8.0, *)
@objcMembers open class WZTabBarItem: UITabBarItem {
    
    /// Customize content view
    open var contentView: WZTabBarItemContentView?
     ...
     */
    public init(_ contentView: WZTabBarItemContentView = WZTabBarItemContentView(), title: String? = nil, image: UIImage? = nil, selectedImage: UIImage? = nil, tag: Int = 0) {
        super.init()
